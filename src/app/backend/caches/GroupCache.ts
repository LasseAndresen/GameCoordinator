...
export class GroupCache extends Cache {
  ...
  private _cachedCompactObjects: {[guid: string]: BehaviorSubject<CompactGroup>} = {};
  private _compactObjectCollectionObservable: BehaviorSubject<CompactGroup[]> = new BehaviorSubject<CompactGroup[]>([]);
  private _compactGroupCollectionUnsubscribeFunction: (() => void) | null = null;
  public collectionObservable: BehaviorSubject<Group[]> = new BehaviorSubject<Group[]>([]);
  ...
  public removeCompactGroup(guid: string) {
    this._removeObject(guid, this._cachedCompactObjects, this._compactObjectCollectionObservable);
  }
