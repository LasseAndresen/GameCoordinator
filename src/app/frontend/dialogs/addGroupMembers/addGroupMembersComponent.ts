import { Component, OnDestroy, OnInit, ViewChild, Optional } from "@angular/core";
...
export class AddGroupMembersDialogComponent implements OnDestroy, OnInit {
    ...
    public async onConfirmClick() {
        ...
        await this._firestoreService.addMemberToGroup(this.emailText, this._dialogArgs.groupID);
        this.closeDialog();
    }
