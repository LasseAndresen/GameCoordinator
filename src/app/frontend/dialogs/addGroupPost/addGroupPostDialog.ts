...
export class AddGroupPostDialog {
    ...
    public show(groupID: string, taggableUsers: string[], existingPost: GroupPost) {
      const dialogArgs = new AddGroupPostDialogArgs(groupID, taggableUsers, existingPost);
      this._dialogService.showDialog<AddGroupPostDialogComponent>(AddGroupPostDialogComponent,
